import { Question } from "./addQuestionCard.js";
...
//         input: 'url',
//         inputLabel: 'Link ảnh',
//         inputPlaceholder: 'Dán link ảnh vào đây',
//         footer: `<p id='auto-id' style='color: blue; cursor: pointer;' onclick="document.getElementById('swal2-input').value = 'https://startupbonsai.com/wp-content/uploads/2020/07/Best-Online-Quiz-Makers-Social.jpg'">Chèn link ảnh mặc định</p>`
//     })
